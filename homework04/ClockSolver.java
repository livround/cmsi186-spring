 ...
 *           -----  ----------  ------------  -----------------------------------------------------------
 *  @version 1.0.0  2018-03-12  Olivia Round  Finalize and release
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */

//if ((currentAngle-targetAngle) <= EPSILON) {
...
public class ClockSolver {
   ...
   */
   public static void main( String args[] ) {
      ...
      Clock clock = new Clock( targetAngle, timeSlice );
      clock.toString();
      while( clock.getTotalSeconds() < 43200 ) {
         clock.tick();
         if ((Math.abs(targetAngle - clock.getHandAngle())) <= cse.EPSILON_VALUE){
          clock.toString();
         }
      }
   }
